export enum Permission {
  ...
  OUTLET_HEAT_MAP_DASHBOARD = "outletHeatMap",
  ...
  CREATE_DEPARTMENT_WALLET = "createDepartmentWallet",
  UPDATE_DEPARTMENT_WALLET = "updateDepartmentWallet",
  ADD_SINGLE_STOCK_MANUALLY = "addSingleStockManually",
  PAYMENT_SUMMARY_REPORT = "paymentSummaryReport",
  SUPERVISOR_REPORT = "supervisorReport",
  SUPERVISOR_CHECKIN_REPORT = "supervisorCheckInReport",
  ORDER_SUMMARY_REPORT = "orderSummaryReport",
  DELIVERY_SUMMARY_REPORT = "deliverySummaryReport",
  ECO_REPORT = "ecoReport",
  CHECKIN_SUMMARY_DETAILS_REPORT = "checkInSummaryDetailsReport",
  STOCK_SUMMARY_REPORT = "stockSummaryReport",
  OUTLET_REPORT = "outletReport",
  ORDER_REJECTION_REPORT = "orderRejectionReport",
  BOUNCE_RATE_REPORT = "bounceRateReport",
  STOCK_SUMMARY_DETAILS_REPORT = "stockSummaryDetailsReport",
  CREATE_PRIORITY_PRODUCT = "createPriorityProduct",
  VIEW_PRIORITY_PRODUCT = "viewPriorityProduct",
  UPDATE_PRIORITY_PRODUCT = "updatePriorityProduct",
  PRIORITY_PRODUCT_STATUS = "priorityProductStatus",
  PRIORITY_PRODUCT_REPORT = "priorityProductReport",
  PRODUCT_PRICE_BULK_UPLOAD = "productPriceBulkUpload",
  PRODUCT_PRICE_HISTORY_REPORT = "productPriceHistoryReport",
  VIEW_PRIMARY_ORDER = "viewPrimaryOrder",
  VIEW_PRIMARY_SALES_RETURN = "viewPrimarySalesReturn",
  VIEW_PRIMARY_INVOICE = "viewPrimaryInvoice",
  VIEW_PRIMARY_READY_TO_DISPATCH = "viewPrimaryReadyForDispatch",
  VIEW_PRIMARY_READY_TO_DELIVERY = "viewPrimaryReadyForDelivery",
  VIEW_PRIMARY_DELIVERY = "viewPrimaryDelivery",
  CREATE_PRIMARY_ORDER_MOBILE = "createPrimaryOrderMobile",
  INVOICE_BULK_ACTION_FOR_DELIVERY = "invoiceBulkActionForDelivery",
  MANAGE_BILLING = "manageBilling",
  SMS_MARKETING_CAMPAIGN = "smsMarketingCampaign",
  VIEW_TRANSACTION_REPORT = "viewTransactionReport",
  STOCK_HISTORY_REPORT = "stockHistoryReport",
  CREATE_CUSTOME_REPORT = "createCustomReport",
  VIEW_CUSTOME_ORDER_REPORT = "viewCustomOrderReport",
  VIEW_CUSTOME_DELIVERY_REPORT = "viewCustomDeliveryReport",
  VIEW_SYSTEM_HISTORY_REPORT = "viewSystemHistoriesReport",
  UPLOAD_BULK_ROUTE_PLAN = "uploadBulkRoutePlan",
  VIEW_LOGIN_HISTORY_REPORT = "viewLoginHistoriesReport",
  VIEW_VISIT_COVERAGE_REPORT = "viewVisitCoverageReport",
  BRAND_REPORTING_DASHBOARD = "brandReportingDashboard",
  HR_VISIT_REPORT = "hrVisitReport",
  HR_DAY_IN_DAY_OUT_REPORT = "hrDayInDayOutReport"
}
