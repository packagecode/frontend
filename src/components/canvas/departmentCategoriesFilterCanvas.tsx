...
const DepartmentCategoriesFilterCanvas: React.FC<ComponentProps> = ({
  visible = false,
  onSubmit,
  onClose
}) => {
  ...
  return (
    <BaseCanvas
      ...
      header={<h5>Department Category Filter</h5>}
      body={
        <div>
          <div className="mb-3">
            <BaseInput
              label="Category Name"
              placeholder="e.g. ABC Category"
              value={filter.name}
              name="name"
...
export default DepartmentCategoriesFilterCanvas;
